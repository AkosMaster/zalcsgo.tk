...
PlayerVars pVars;
void PlayerVars::init() {

	netvar_tree netvar;

	m_lifeState = netvar.get_offset("DT_BasePlayer", "m_lifeState");
	m_iHealth = netvar.get_offset("DT_BasePlayer", "m_iHealth");
	m_iTeamNumber = netvar.get_offset("DT_BaseEntity", "m_iTeamNum");
	m_VecOrigin = netvar.get_offset("DT_BaseEntity", "m_vecOrigin");
	m_Class = netvar.get_offset("DT_TFPlayerResource", "m_iPlayerClass");
	m_iObserverMode = netvar.get_offset("DT_BasePlayer", "m_iObserverMode");
}